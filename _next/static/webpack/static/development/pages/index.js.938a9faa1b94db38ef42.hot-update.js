...
function calculateScore(reliability, credibility, intimacy, self_orientation) {
  return (reliability + credibility + intimacy) / self_orientation;
}
...
function calculatePercentage(score) {
  ...
  var max_score = (max_reliability + max_credibility + max_intimacy) / max_self_orientation;
  return score / max_score;
}

function getCategoryPoints(allPoints, categoryId) {
  pointsObj = allPoints.find(function (category) {
...
var totalPointsFromMilestoneMap = function totalPointsFromMilestoneMap(milestoneMap) {
  ...
  var reliability = allCategoryPoints.find(function (category) {
    return category.categoryId == "A";
  }).points;
  var credibility = allCategoryPoints.find(function (category) {
    return category.categoryId == "B";
  }).points;
  var intimacy = allCategoryPoints.find(function (category) {
    return category.categoryId == "C";
  }).points;
  var self_orientation = allCategoryPoints.find(function (category) {
    return category.categoryId == "D";
  }).points;
...
//# sourceMappingURL=index.js.938a9faa1b94db38ef42.hot-update.js.map