...
var totalPointsFromMilestoneMap = function totalPointsFromMilestoneMap(milestoneMap) {
  ...
  return calculatePercentage(calculateScore(reliability, credibility, intimacy, self_orientation)) * 100; // return trackIds.map(trackId => milestones[milestoneMap[trackId]].points).reduce((sum, addend) => (sum + addend), 0)
};
...
//# sourceMappingURL=index.js.d50c6e2bd3724da644f3.hot-update.js.map