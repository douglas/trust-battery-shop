...
/*!**********************!*\
  !*** ./constants.js ***!
  \**********************/
/*! exports provided: milestones, milestoneToPoints, pointsToLevels, maxLevel, tracks, trackIds, categoryIds, categoryPointsFromMilestoneMap, totalPointsFromMilestoneMap, categoryColorScale, titles, eligibleTitles */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "milestoneToPoints", function() { return milestoneToPoints; });
...
var milestones = [0, 1, 2, 3, 4, 5];
var milestoneToPoints = function milestoneToPoints(milestone) {
  switch (milestone) {
    case 0:
      return 0;
...
var trackIds = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_3___default()(tracks);
...
var categoryColorScale = d3__WEBPACK_IMPORTED_MODULE_4__["scaleOrdinal"]().domain(categoryIds).range(['#00abc2', '#428af6', '#e1439f', '#e54552']);
var titles = [{
  label: 'Wouldn’t trust you with my hamburger',
  minPoints: 0,
  maxPoints: 16
}, {
  label: 'Engineer II',
...
//# sourceMappingURL=index.js.bc2e592ecba87108b3d1.hot-update.js.map